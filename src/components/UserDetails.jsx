    ...
    return (
        <div className="w-full h-screen bg-gray-100" style={{ backgroundColor: themes.background, color: themes.text }}>
            <div className="w-4/5 mx-auto px-4 py-8">
                ...
                {/* Spinner para detalles del usuario */}
                {!user ? (
                    <div className="flex justify-center items-center p-8 bg-gray-800 rounded-lg">
                        <div className="flex flex-col items-center">
                            <div className="animate-spin -ml-1 mr-3 h-10 w-10 text-white">
                            ...
                            <p className="mt-2 text-gray-400">Cargando detalles del usuario...</p>
                        </div>
                    </div>
                ) : (
                ...
                {/* Spinner para tabla de miembros */}
                {familyMembers.length === 0 ? (
                    <div className="flex justify-center items-center p-8 bg-gray-800 rounded-lg">
                        <div className="flex flex-col items-center">
                            ...
                            <p className="mt-2 text-gray-400">Cargando integrantes de la familia...</p>
                        </div>
                    </div>
                ) : familyMembers.length > 0 ? (
                    ...
                    <p className="text-center p-4 bg-gray-800 rounded-lg text-gray-400">
                        No se encontraron miembros de la familia.
                    </p>
                )}
            </div>
        </div>
